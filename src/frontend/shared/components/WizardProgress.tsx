...
export function WizardProgress({ currentStep, steps, ariaLabel = 'Progreso' }: WizardProgressProps) {
    return (
        <nav aria-label={ariaLabel} className="flex items-center justify-center gap-0 mb-6">
